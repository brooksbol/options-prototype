...
| **P4** — Vocabulary / Coherence | **NEXT** | Residual coherence work per the P4 definition below; owns remaining `/labs` vocabulary, WriteDesk→Deployment naming, `scan-orchestrator.ts` type relocation, obsolete workspace/CSS pruning, and `PL-POSTURE-01`. |
