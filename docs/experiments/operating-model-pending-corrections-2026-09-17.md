...
The corrections are approved for codification when BUG-021 reaches its next safe stop. This branch record exists so the approval does not depend on conversational memory while the in-flight candidate remains undisturbed.
