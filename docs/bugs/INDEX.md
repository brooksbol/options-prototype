...
| BUG-022 | Deployable cash is regime-unaware: balances parser folds margin-derived buying power into the legacy "all settled" slot, over-stating unlevered deployable on a margin-enabled account | Write Desk / broker-balance ingestion + deployable-cash derivation | Not established | Open | [record](BUG-022-deployable-cash-regime-unaware-folds-margin-buying-power.md) | Discovered 2026-09-17 |
