...
`[MECH]` Equity and ETF options are **physically settled**: an exercised/assigned ITM option is exchanged for **shares**, not cash. (Contrast index options like SPX, which cash-settle — out of Wheelwright scope.)
