...
public class DatabaseManager {
    ...
    private static List<String> listMigrationFiles() {
        ...
        String[] known = {"001_initial.sql", "002_spot_history.sql", "003_monitored_positions.sql", "004_opportunity_history.sql", "005_provider_provenance.sql", "006_correct_invented_legacy_provenance.sql", "007_held_expirations.sql"};
